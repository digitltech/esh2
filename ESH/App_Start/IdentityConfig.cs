...
namespace ESH
{
    ...
    public class ApplicationUserManager : UserManager<ESHDBModels.ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<ESHDBContext>()));
